...
measure_distance <- function(mod, data) {
  predictions = model1(mod, data)
  difference = predictions - data$y
  difference_square = difference^2
  #difference_square_sum = sum(difference_square)
  #ecm = sqrt(difference_square_sum/length(predictions))
  ecm = sqrt(mean(difference_square))
  return (ecm)
}
